...
class Interface:
    ...
    def output(self, hp, lvl, room, ammos):
        # Вывод интерфейса
        ...
        text_ammos = self.font.render(f'{ammos}', True, 'black')
        return [text_hp, text_lvl_room, 790 - text_lvl_room_rect.right - text_lvl_room_rect.left, text_ammos]
